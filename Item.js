...
class Item extends React.Component {
    ...
    showImg() {
        this.props.navigation.navigate('bigphoto', { address: this.props.address, res: this.props.res, loc: this.props.loc, ids: this.props.ids, wid: this.props.wid, hig: this.props.hig })
    }
    select() {
